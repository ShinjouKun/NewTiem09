...
public:
	...
	//ID3D12DescriptorHeap* GetSpriteDescripterHeap()const;//3d用
	void Clear();
private:
...
//static ComPtr<ID3D12DescriptorHeap>SpriteDescHeap;//デスクリプタヒープ2D
//static ComPtr<ID3D12DescriptorHeap>ParticleDescHeap;//デスクリプタヒープパーティクル用
};
